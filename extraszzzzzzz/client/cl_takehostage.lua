...
RegisterNetEvent('csx_functionstakehostage:syncTarget')
AddEventHandler('csx_functionstakehostage:syncTarget', function(target, animationLib, animation2, distans, distans2, height, length,spin,controlFlag,animFlagTarget,attach)
...
RegisterNetEvent('csx_functionstakehostage:syncMe')
AddEventHandler('csx_functionstakehostage:syncMe', function(animationLib, animation,length,controlFlag,animFlag)
	local playerPed = GetPlayerPed(-1)
	ClearPedSecondaryTask(GetPlayerPed(-1))
	RequestAnimDict(animationLib)
	while not HasAnimDictLoaded(animationLib) do
...
RegisterNetEvent('csx_functionstakehostage:cl_stop')
AddEventHandler('csx_functionstakehostage:cl_stop', function()
	holdingHostageInProgress = false
	beingHeldHostage = false 
...
Citizen.CreateThread(function()
	while true do 
		...
		if holdingHostage then
			...
			DrawText3DTH(playerCoords.x,playerCoords.y,playerCoords.z,"Press [G] to release, [H] to kill")
...
function DrawText3DTH(x,y,z, text)
